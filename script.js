document.addEventListener('DOMContentLoaded', function() {
    ...
    const points = {
        'Marie Curie': [20, 12, 8, 6, 4, 3, 2, 0],
        'Albert Einstein': [16, 16, 11, 7, 5, 4, 2, 1],
        'Erwin Schrödinger': [12, 12, 14, 9, 7, 5, 3, 2],
        'Albert Camus': [10, 10, 11, 12, 8, 6, 4, 4],
        'Martin Luther King Jr.': [8, 8, 8, 9, 11, 8, 5, 5],
        'Mother Teresa': [6, 6, 7, 7, 8, 10, 7, 5],
        'Malala Yousafzai': [5, 5, 5, 6, 7, 9, 9, 7],
        'Bob Dylan': [4, 4, 4, 4, 5, 6, 7, 8]
    };

    const correctOrder = [
        { city: 'Marie Curie', year: '1903' },
        { city: 'Albert Einstein', year: '1921' },
        { city: 'Erwin Schrödinger', year: '1933' },
        { city: 'Albert Camus', year: '1957' },
        { city: 'Martin Luther King Jr.', year: '1964' },
        { city: 'Mother Teresa', year: '1979' },
        { city: 'Malala Yousafzai', year: '2014' },
        { city: 'Bob Dylan', year: '2016' }
    ];
